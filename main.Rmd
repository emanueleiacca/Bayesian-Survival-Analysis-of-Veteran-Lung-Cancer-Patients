...
", file = "Exponential Models/exponential_intercept.jags")
```

```{r}
# Run model
model = jags.model("Exponential Models/exponential_intercept.jags", data = exp_baseline_data, n.chains = 3)
update(model, 1000)
...
", file = "Exponential Models/exponential_aft.jags")
```

```{r}
model = jags.model("Exponential Models/exponential_aft.jags", data = exp_AFT_celltypes_data, n.chains = 3, n.adapt = 1000)
update(model, 1000)
...
", file = "Exponential Models/exponential_aft_censored.jags")
```

```{r}
model = jags.model("Exponential Models/exponential_aft_censored.jags", data = exp_data_complete_AFT,
...
", file = "Weibull Models/weibull_intercept.jags")
...
```{r}
#run the model
model = jags.model("Weibull Models/weibull_intercept.jags", data = weibull_data_baseline, n.chains = 3, n.adapt = 1000)
...
", file = "Weibull Models/weibull_aft_celltype.jags")

```

```{r}
model = jags.model("Weibull Models/weibull_aft_celltype.jags", data = weibull_data_AFT_tumor_type, n.chains = 3, n.adapt = 1000)
update(model, 1000)  
...
", file = "Weibull Models/weibull_aft_fullcov_nocensor.jags")
```

```{r}
model = jags.model("Weibull Models/weibull_aft_fullcov_nocensor.jags", data = weibull_data_nocensor, n.chains = 3, n.adapt = 1000)
update(model, 1000)
...
", file = "Simulation Models/weibull_nocensor.bug")
```
...
model_sim = jags.model("Simulation Models/weibull_nocensor.bug", data = data_jags_sim, inits = inits, n.chains = 3, n.adapt = 1000)
...
", file = "Simulation Models/weibull_recovery.bug")
...
model_sim2 = jags.model("Simulation Models/weibull_recovery.bug", data = data_jags_sim2, inits = inits2,
                         n.chains = 3, n.adapt = 1000)
